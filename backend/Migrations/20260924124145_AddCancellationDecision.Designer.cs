...
namespace backend.Migrations
{
    ...
    [Migration("20260924124145_AddCancellationDecision")]
    partial class AddCancellationDecision
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.NotificationOutbox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.OrderItem", b =>
                {
                    ...
                    b.Property<int?>("SellerIdSnapshot")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.OrderTable", b =>
                {
                    ...
                    b.Property<string>("CancelDecisionReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("CancelPreviousStatus")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("backend.Models.ShippingEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.Refund", b =>
                {
                    b.HasOne("backend.Models.OrderTable", null)
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend.Models.Payment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.ShippingEvent", b =>
                {
                    b.HasOne("backend.Models.ShippingInfo", null)
                        .WithMany()
